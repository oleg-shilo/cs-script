...
//
	...
	for (var i = 0; i < anchors.length; i++)
	{
		...
		{
			if (aref.substring(0, 3) == '../')
				aref = base + aref.substring(3); //to work with Mozilla
			else
				aref = base + aref;
		}
...
function resizeTree()
{
	...
	treeDiv.style.height = 1000;// for some reason it is calculated incorrectly under Firefox
}
